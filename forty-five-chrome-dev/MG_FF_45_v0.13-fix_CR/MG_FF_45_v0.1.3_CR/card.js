...
//-----------------------------------------------------------------------------
   ...
   function CardObj (rank, suit, cardNumber, cardFilename, cardColour, suitValue) {
  /**
   ...
   * @param 
   */ 
  //document.getElementById('card').addEventListener('click', selectCard, false);
...
//-----------------------------------------------------------------------------
// @ param cardSym identifier getter
//-----------------------------------------------------------------------------
/*************************************************************
 this.cardSym  = function ()  {
  //
...
this.clickCard = function (e) {
        ...
        var p = el.cloneNode(false);
          ...
          if (sourcePlayer === "playerHand") {
            ...
            //p1SelectTemp.addCard(el);
            //}
            //p1TrickStack.cardCreateNode();
            //p1TrickStack.addCard(playerHand.cardStack[i].index);
            //var c = document.getElementById("playerHand").cardStack
