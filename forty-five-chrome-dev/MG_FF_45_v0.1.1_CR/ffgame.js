...
function newGame() {
  ...
  discards.combine(player4Hand);
  discards.combine(trump);
  if (p1SelectTemp.cardDeck.length === null || p1SelectTemp.cardDeck.length === null
    || p1SelectTemp.cardDeck.length == null || p1SelectTemp.cardDeck.length === null) {
...
function reDrawUI() {
  ...
  left = 0;
  el = document.getElementById("p1SelectTemp");
  while (el.firstChild !== null) {
    el.removeChild(el.firstChild);
  }
  n = p1SelectTemp.cardCount();
  for (i = 0; i < p1SelectTemp.cardCount(); i++) {
    node = p1SelectTemp.cardDeck[i].createNode();
    node.style.left = left + "em";
    el.appendChild(node);
    left += 1.00;
  }
  ...
  left = 0;
  el = document.getElementById("p2SelectTemp");
  while (el.firstChild !== null) {
    el.removeChild(el.firstChild);
  }
  n = p2SelectTemp.cardCount();
  for (i = 0; i < p2SelectTemp.cardCount(); i++) {
    node = p2SelectTemp.cardDeck[i].createNode();
    node.style.left = left + "em";
    el.appendChild(node);
    left += 1.00;
  }
  ...
  left = 0;
  el = document.getElementById("p3SelectTemp");
  while (el.firstChild !== null) {
    el.removeChild(el.firstChild);
  }
  n = p3SelectTemp.cardCount();
  for (i = 0; i < p3SelectTemp.cardCount(); i++) {
    node = p3SelectTemp.cardDeck[i].createNode();
    node.style.left = left + "em";
    el.appendChild(node);
    left += 1.00;
  }
  ...
  left = 0;
  el = document.getElementById("p4SelectTemp");
  while (el.firstChild !== null) {
    el.removeChild(el.firstChild);
  }
  n = p4SelectTemp.cardCount();
  for (i = 0; i < p4SelectTemp.cardCount(); i++) {
    node = p4SelectTemp.cardDeck[i].createNode();
    node.style.left = left + "em";
    el.appendChild(node);
    left += 1.00;
  }
