        ...
        var p = el.cloneNode(false);
          ...
          if (sourcePlayer === "playerHand") {
            ...
            for (i = 0; i < playerHand.cardDeck.length; i++) {
              ...
              tempCard = playerHand.cardDeck[i];
              p1SelectTemp.cardDeck[i].addCard(tempCard);
              playerHand.cardDeck[i].removeCard(tempCard);
              console.log("REMOVED " +tempCard);
              }
              ***************************************************/
            //p1SelectTemp.creatNode();
